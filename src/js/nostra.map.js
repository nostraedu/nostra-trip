...
$(document).ready(function () {
    ...
    nostra.onready = function () {
        ...
        map.events.click = function (evt) {
            addLocation(evt.mapPoint.getLatitude(), evt.mapPoint.getLongitude());
        }
    };
    ...
    function callIdentifyService() {
        ...
        var key = "G2eVC7ZjeF(oP1Wfop)UqgewO4gjCGHGfvFDwVaypuwBQ0iZ2XSveGTTxRmVJAlABNSqSjLtObsUXuJE0VUcWmG=====2";
